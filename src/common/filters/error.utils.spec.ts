...
describe('ErrorUtils', () => {
  ...
  it('should get error message from bad request exception - exists', () => {
    ...
    expect(getErrorMessage(exception.getResponse())).toBe('email address does not exists')
  })
  ...
  it('should get error message from bad request exception - two constraints', () => {
    ...
    expect(getErrorMessage(exception.getResponse())).toBe('email not be empty -- email not be null')
  })
  ...
  it('should get INTERNAL_SERVER_ERROR message from exception', () => {
    ...
    expect(getErrorMessage(exception.getResponse())).toBe('INTERNAL_SERVER_ERROR')
  })
})
